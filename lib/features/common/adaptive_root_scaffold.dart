...
import 'package:reaeeman/features/stats/widget/side_bar_stats_overview.dart';
...
class AdaptiveRootScaffold extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final destinations = [
      ...
      NavigationDestination(
        icon: const Icon(FluentIcons.apps_20_regular),
        label: t.subscribe.pageTitle,
      ),
      NavigationDestination(
        icon: const Icon(FluentIcons.person_20_regular),
        label: t.center.pageTitle,
      ),
      NavigationDestination(
        icon: const Icon(FluentIcons.book_globe_20_filled),
        label: t.knowledge.pageTitle,
      ),
      // NavigationDestination(
