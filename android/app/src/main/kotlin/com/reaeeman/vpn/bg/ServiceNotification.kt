...
import com.reaeeman.vpn.Application
import com.reaeeman.vpn.MainActivity
import com.reaeeman.vpn.R
import com.reaeeman.vpn.Settings
import com.reaeeman.vpn.constant.Action
import com.reaeeman.vpn.constant.Status
import com.reaeeman.vpn.utils.CommandClient
    ...
    fun show(profileName: String, @StringRes contentTextId: Int) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            Application.notification.createNotificationChannel(
                NotificationChannel(
                    notificationChannel, "reaeeman service", NotificationManager.IMPORTANCE_LOW
                )
            )
        }
        service.startForeground(
            notificationId, notificationBuilder
                .setContentTitle(profileName.takeIf { it.isNotBlank() } ?: "ReaeemanVPN")
